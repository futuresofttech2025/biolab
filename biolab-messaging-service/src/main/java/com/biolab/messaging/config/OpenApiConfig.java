package com.biolab.messaging.config;
 ...
 * Access at: <a href="http://localhost:8086/swagger-ui.html">Swagger UI</a>
 */
@Configuration
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
            .info(new Info()
                .title("Messaging API")
                .description("Real-time messaging between project stakeholders")
                .version("1.0.0")
