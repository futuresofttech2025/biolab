package com.biolab.document.config;
 ...
 * Access at: <a href="http://localhost:8089/swagger-ui.html">Swagger UI</a>
 */
@Configuration
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Upload, download, and manage project documents with versioning")
                .version("1.0.0")
